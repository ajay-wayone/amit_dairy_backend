                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h5 class="mb-1">{{ number_format($stats['pending_orders']) }}</h5>
            ...
            <div class="card dashboard-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h5 class="mb-1">{{ number_format($stats['today_orders']) }}</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('admin.orders.show', $order->id) }}" class="text-body fw-bold">
                                            {{ $order->order_code }}
                                        </a>
                                    </td>
            ...
            <div class="card dashboard-card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="rounded" width="40">
                        </div>
                        <div class="flex-grow-1 ms-3">
