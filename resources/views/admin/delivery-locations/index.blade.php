            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <form method="GET" action="{{ route('admin.delivery-locations.index') }}" class="d-flex">
                            <input type="text" name="search" class="form-control me-2" placeholder="Search locations..." value="{{ request('search') }}">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>₹{{ number_format($location->delivery_charge ?? 0, 2) }}</td>
                                <td>₹{{ number_format($location->minimum_order ?? 0, 2) }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.delivery-locations.edit', $location->id) }}" class="btn btn-sm btn-warning">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="text-muted">
                        Showing {{ $deliveryLocations->firstItem() }} to {{ $deliveryLocations->lastItem() }} of {{ $deliveryLocations->total() }} entries
                    </div>
