...
@section('title', 'Add Delivery Location - Admin Dashboard')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Add Delivery Location</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.delivery-locations.store') }}">
                        @csrf

                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="name" class="form-label small">Location Name *</label>
                                <input type="text" name="name" id="name" placeholder="Enter the location...."
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" id="address" placeholder="Enter the address..."
                                    class="form-control form-control-sm @error('address') is-invalid @enderror" rows="3" required>{{ old('address') }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback small">{{ $message }}</div>
                                @enderror
                            </div>
