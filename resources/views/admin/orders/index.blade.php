...
@push('styles')
    ...
    color: #98a6ad;
    pointer-events: none; /* Yeh line add karo */
}
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            function performSearch(page = 1) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $('#ordersTable').html('<div class="text-center py-4">Loading...</div>');
                    },
                    ...
                    error: function(xhr) {
                        ...
                        $('#ordersTable').html('<div class="alert alert-danger">Error loading orders. Please try again.</div>');
                    }
                });
            }
            ...
            $('#statusFilter, #paymentFilter').on('change', function() {
                performSearch(1); // Reset to first page when filters change
            });
    ...
    if (nextStatus) {
        Swal.fire({
            ...
            text: `Change status from "${statusDisplayNames[currentStatus]}" to "${statusDisplayNames[nextStatus]}"?`,
            icon: 'question',
