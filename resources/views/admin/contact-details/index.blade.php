    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.contact-details.update', $settings->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="about_us" id="about_us" class="form-control form-control-sm @error('about_us') is-invalid @enderror"
                                    rows="3">{{ old('about_us', $settings->about_us ?? '') }}</textarea>
                                @error('about_us')
                                    <div class="invalid-feedback small">{{ $message }}</div>
                                @enderror
                            </div>
